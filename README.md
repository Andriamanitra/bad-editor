...
> [!WARNING]
> This project is still in development, there are bugs and some things are not implemented yet.
> Once it works properly I might change the name to *mediocre-editor* or something.

## Demo on Asciinema
<a href="https://asciinema.org/a/797202" target="_blank" rel="noopener noreferrer"><img src="https://asciinema.org/a/797202.svg" /></a>

## Goals:

> [!IMPORTANT]
> These are long term goals, many of them are not fully implemented yet. Progress is being tracked in [issue #1](https://github.com/Andriamanitra/bad-editor/issues/1).
